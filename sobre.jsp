	...
	<body onLoad="listaCategs()">
		...
		<div class="container">	
			<div class="container marketing" id="conteudo">
				<img src="img/cat6.jpg" id="imgsobre" class="img-responsive"
				alt="Imagem responsiva" />
				<div class="texto">
					<h1>Sobre</h1>
					<p>Nossa empresa é especializada em produtos para Cães &
						Gatos, com a intenção de trazer o que há de mais novo no mercado
						internacional para nossos consumidores, procuramos sempre manter
						nosso alto padrão de qualidade. Parte dos nossos lucros são
						doados para instituições não governamentais que ajudam os
						animais.</p>
					<p>Para mais informações entre em contato conosco acessando a
						guia de contato no menu superior de nossa página.</p>
				</div>
			</div>
